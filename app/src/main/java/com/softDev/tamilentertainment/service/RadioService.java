package com.softDev.tamilentertainment.service;
/**
...
import com.softDev.tamilentertainment.activity.MainActivity;
import com.softDev.tamilentertainment.R;
import com.softDev.tamilentertainment.util.LastFMCover;
import com.softDev.tamilentertainment.util.PlsParser;
...
public class RadioService extends Service implements OnErrorListener,
	...
	public void showNotification() {
		notifyBuilder = new NotificationCompat.Builder(this)
				.setSmallIcon(R.drawable.notlogo).setContentTitle(app_name)
				.setContentText("");
		...
		notifyBuilder.setContentIntent(resultPendingIntent).setAutoCancel(true);
